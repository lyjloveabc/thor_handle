...
class ImportUserBackup(object):
    ...
    def handle(self):
        ...
        admin_employee_group = ImportUserBackup.get_admin_employee_group()
        admin_user_group = ImportUserBackup.get_admin_user_group()

        zone_category_group = ImportUserBackup.get_zone_category_group()

        with open(ImportUserBackup.__BASE_PATH + 'ImportUserBackup_out' + ImportUserBackup.__DAY + '.sql', 'w') as f:
            f.write('BEGIN;\n')
    ...
    def get_admin_employee_group():
        ...
        with open(ImportUserBackup.__BASE_PATH + 'admin_employee' + ImportUserBackup.__DAY + '.txt', 'r') as f:
    ...
    def get_admin_user_group():
        ...
        with open(ImportUserBackup.__BASE_PATH + 'admin_user' + ImportUserBackup.__DAY + '.txt', 'r') as f:
            for line in f.readlines():
                temp = line[:-1].split(';')
                old_user = {
                    'mobile': temp[0],
    ...
    def get_zone_category_group():
        ...
        with open(ImportUserBackup.__BASE_PATH + 'itl_zone_category' + ImportUserBackup.__DAY + '.txt', 'r') as f:
            for line in f.readlines():
