...
class UpdateSomeUser:
    ...
    def handle(self):
        mobile_group = set()
        admin_employee_group = UpdateSomeUser.get_admin_employee_group()
        zone_category_group = UpdateSomeUser.get_zone_category_group()

        with open(UpdateSomeUser.BASE_PATH + 'UpdateSomeUser_out' + UpdateSomeUser.DAY + '.sql', 'w') as f:
            f.write('BEGIN;\n')
            ...
            for key in admin_employee_group_keys:
                ...
                admin_employee = self.data_cleansing(admin_employee_group[key])
    ...
    def get_admin_employee_group():
        ...
        with open(UpdateSomeUser.BASE_PATH + 'admin_employee_for_update_some' + UpdateSomeUser.DAY + '.txt', 'r') as f:
    ...
    def get_zone_category_group():
        ...
        with open(UpdateSomeUser.BASE_PATH + 'itl_zone_category' + UpdateSomeUser.DAY + '.txt', 'r') as f:
            for line in f.readlines():
    ...
    @staticmethod
    def data_cleansing(admin_employee):
