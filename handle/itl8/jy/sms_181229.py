...
data = ReadUtil.read_file('发短信电话-20181213(1).xls', {'z': 0, 'm': 1, 's': 2, 'name': 3, 'mobile': 4})  # 原始数据
...
# need_send_mobile = ['18768111223', '13216120922']

r = requests.post(url, data={'temp': 'tsZnqActivityTips', 'mobileList': need_send_mobile})
