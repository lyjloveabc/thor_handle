...
INSERT INTO bill (id,
                  ...
                  financial_income,
                  sub_period_id)
VALUES ({b_id}, '2017年12月-2018年11月', now(), now(), '2017-12-01', '2018-11-30', {ought_amount}, 45, 'shopPublicMaintenance',39, 0, 'NO_PAY', '商铺公共维修费 2017年12月-2018年11月', 76, 1, {financial_income}, 180);
...
for row in data:
    print(
        sql.format(
            b_id=b_id, ought_amount=row['money'], financial_income=row['money'],
